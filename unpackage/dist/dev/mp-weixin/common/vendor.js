    ...
    return new Proxy(this, {
      get: (target, prop) => {
        if (prop in target) {
          ...
          return isFunction$1(value) ? value.bind(target) : value;
        }
...
function parseXReturnValue(methodName, res) {
  ...
  if (protocol && isFunction$1(protocol.returnValue)) {
...
function initRuntimeSocketService() {
  const hosts = "26.26.26.1,192.168.3.188,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_Hdd7qk";
